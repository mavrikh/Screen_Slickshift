"""
Slickshift mainline -- pynput-based mouse button and scroll event capture.
...
This module is independent of the polling-based MouseCapture (motion). Both run
...
class EventCapture:
    ...
    def start(self) -> None:
        ...
        self._listener = _pynput_mouse.Listener(
            ...
            on_move=None,  # motion is handled by MouseCapture's polling loop
        )
    ...
    def _pynput_on_click(
        ...
        handled by MouseCapture). button is a pynput Button enum; we convert it
